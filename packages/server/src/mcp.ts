...
const PROMPT_TEXTS: Record<string, string> = {
  review: `あなたはふりかえりの伴走者です。ユーザーの中間ふりかえりを対話的に進行してください。
...
- 日本語で会話する`,
  ...
  review_final: `あなたはふりかえりの伴走者です。ユーザーの最終ふりかえり（目標期間の締めくくり）を対話的に進行してください。
...
- 日本語で会話する`,
  ...
  set_goal: `あなたはふりかえりの伴走者です。ユーザーの目標設定を対話的にサポートしてください。
...
mcpServer.registerPrompt(
  ...
  () => ({
    messages: [
      {
        role: 'user' as const,
        content: { type: 'text' as const, text: PROMPT_TEXTS['review'] },
      },
    ],
  }),
)
...
mcpServer.registerPrompt(
  ...
  () => ({
    messages: [
      {
        role: 'user' as const,
        content: { type: 'text' as const, text: PROMPT_TEXTS['review_final'] },
      },
    ],
  }),
)
...
mcpServer.registerPrompt(
  ...
  () => ({
    messages: [
      {
        role: 'user' as const,
        content: { type: 'text' as const, text: PROMPT_TEXTS['set_goal'] },
      },
    ],
  }),
)
